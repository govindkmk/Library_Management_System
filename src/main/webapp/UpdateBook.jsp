...
<body>
    ...
    <h5 style="margin: 15px;">Update Book</h5><hr>
	<%
          ...
          <tr>
            <td>
              <form action="UpdateBook">
	              ...
	              <input class="form-control" type="text" value=<%= book.getName() %> name="name"><br>
	              <div class="form-group">
                    <label for="">Category</label><br>
                    
                    <select name="category" class="form-control" value=<%= book.getCategory().getName() %>>
                    ...
                    <select name="author" class="form-control" value=<%= book.getAuthor().getName() %>>
                    	<option disabled="disabled" selected="selected">--Select Author--</option>
                    <% for(Author author: authors) {%>
                        <option value="<%= author.getName()%>"><%= author.getName()%></option>
                    <%} %>
                    </select>
	              <label for="">ISBN Number</label><br>
	              <input class="form-control" type="text" value=<%= book.getIsbnNumber() %> name="isbn"><br>
	              <label for="">Price</label><br>
	              <input class="form-control" type="text" value=<%= book.getPrice() %> name="price"><br>
