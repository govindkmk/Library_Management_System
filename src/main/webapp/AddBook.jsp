<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="dao.*, daoimpl.*, model.*, java.util.List, java.util.ArrayList"%>
...
<body>
    ...
    <h5 style="margin: 15px;">Add Book</h5><hr>
	<% 
          ...
          <tr>
            <td>
              <form action="AddBook">
	              ...
	              <input class="form-control" type="text" name="isbnNumber" required><br>
