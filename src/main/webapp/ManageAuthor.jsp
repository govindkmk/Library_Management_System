<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="model.Author, java.util.List, java.io.IOException, java.sql.SQLException, dao.AuthorDAO, daoimpl.AuthorDAOImp, java.util.ArrayList"%>
...
<body>
    ...
    <h5 style="margin: 15px;">Manage Author</h5><hr>
    <%
    ...
    <div class="container">
        <table class="table" border="1">
          <thead class="thead">
            <th colspan="5">Author Listing</th>
          </thead>
          <tbody>
            <tr>
              <td>
                <thead>
                  ...
                  <% for(Author author: authors){ %>	
                    <tr>
                      ...
                      <td><%= author.getCreationDate() %></td>
                      <td><%= author.getUpdationDate() %></td>
                      <td>
	                      <a href="EditAuthor?action=UPDATE&authorId=<%= author.getId() %>"><button type="button" class="btn btn-outline-success">Edit</button></a>
	                      <a href="DeleteAuthor?action=DELETE&authorId=<%= author.getId() %>"><button type="button" class="btn btn-outline-danger">Delete</button></a>
                      </td>
                    </tr>
                  <%} %>
                  </tbody>
